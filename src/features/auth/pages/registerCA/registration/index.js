...
export { default as CredentialsDetails } from './CredentialsDetails';
export { default as PracticeDetails } from './PracticeDetails';
export { default as SpecialtiesDetails } from './SpecialtiesDetails';
